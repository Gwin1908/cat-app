    ...
    <section className="voting-section">
      ...
      <div className="voting-content">
        <div className="voting-header">
          ...
          <h2 className="voting-title">Voting</h2>
        </div>
        <div className="voting-main">
          <img className="voting-image" src="image 1.png" alt="voting image" />
          <div className="voting-buttons">
            <button className="vote-like">
              <svg
            ...
            <button className="vote-favorite">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="30"
                height="26"
